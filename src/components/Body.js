...
function Webbody() {
  ...
  <div className='flex items-center justify-center flex-col p-0'>
    <div className='w-full flex items-center justify-center flex-col pb-[0 !important] pt-[5%] lg:pt-[0] lg:pb-[6%] lg:h-[90vh] my-[10%] lg:my-0 lg:mt-[2%]' style={{backgroundImage: `url(${backgroundImage})`}} >
      ...
      <h4 className='max-w-xl lg:px-0 text-sm lg:text-lg px-7'>Walkers Dao is a community driven organization empowering and educating individuals through the Web3 journey. We pave the way for innovative solutions, community driven initiatives and a collective vision of progress steps into the world of Web3. At our Dao, every stride shapes the future we envision together.</h4>
      <div>
      <button className="bg-black text-white mt-5 lg:mt-7 flex p-2 pl-3 lg:p-3 rounded-md text-sm">
  ...
  return (
    <div className='lg:flex flex-col py-[3%] mt-5 lg:justify-between items-center lg:px-[5%] bg-[#F9F9FB] mx-[5%]'>
      <div className='flex flex-col items-center'>
          <h1 className='text-base lg:text-4xl text-center max-w-[85%] lg:max-w-[60%]'>The digital world is full of innovation. We khow to take advantage of them!</h1>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='bg-[#fff] lg:max-w-[67%] px-5 lg:py-[1.5%] lg:px-[3%] my-5 lg:my-10 rounded-2xl py-4 border-2 border-[#2f59bc17] shadow-lg shadow-[ 0px 17px 36px rgba(0, 0, 0, 0.02)] lg:justify-end lg:float-right '>
          ...
          <h6 className='text-sm lg:text-base'>Enabling the complexities in web3 technologies enabling anyone to thrive in the ecosystem, through education, innovations, mentorship and community management.</h6>
        </div>    
      </div>   
      </div>
    </div>
