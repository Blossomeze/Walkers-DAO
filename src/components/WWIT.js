  ...
  return (
    <div className='bg-[#464646] pt-[5%] lg:pt-[3%] px-0 lg:px-[5%]'>
        <div className='flex flex-col items-center'>
            <h1 className='text-2xl lg:text-4xl text-white text-center'><span className='text-primary'>WALKERS</span> WOMEN IN Web3<br/>COMING SOON!</h1>
        </div>
        <div className='flex flex-col lg:flex-row text-white items-center justify-between px-[5%]'>
    <div className='lg:w-[65%]'>
        <h4 className='text-white lg:text-left text-sm lg:text-2xl pt-5 lg:pt-0'>Hey there, ladies! We know that getting started in the crypto world and web3 can be a bit overwhelming, no need to panic, we're here to help. We'll take you through the basics, one step at a time, and we'll make sure you feel confident and empowered by the end.</h4>
