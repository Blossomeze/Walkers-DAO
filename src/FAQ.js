...
import Question from '../../walkers/src/components/Question';
  ...
  return (
    <div className='flex items-center justify-center flex-col p-0 mt-[12%] lg:mt-0 bg-white'>
      ...
      <Question
        ...
        answer="Auslyn Walker founded on March 2023"
      />
      <Question
        question="What are the benefits of joining Walkers DAO?"
        answer={[
            "Joining Walkers DAO has a lot of benefits ",
            "from gaining knowledge about the crypto and web3 space to ",
      ...
      <Question
        ...
        answer="Becoming a member of the DAO is pretty easy. Just join through the links on our social media handles. No big deal, no payment. Getting involved with Walkers DAO is quite easy. All you need to do is to show up everyday."
      />
      <Question
      ...
      <Question
        ...
        answer="At our DAO, lots of resources are available. You have access to detailed and legit airdrops, testnets, retroactive drops, stakings. Not just that, you'll have guidelines to them with tutorials on community management and web3 jobs."
      />
      <Question
        question="What are the terms and conditions of membership in WalkersDAO?"
        answer="The terms and conditions of the DAO are quite simple and are stated on our various social media platforms."
      />
      <Question
        question="How can I contact the team @Walkers DAO?"
        answer="To contact the team, send an email to walkersdao1@gmail.com. Ensure you state clearly the subject of the email as that will determine the speed of our response."
      />
    </div>
